...
namespace SmsBus.Web.Migrations
{
    ...
    [Migration("20260313073621_SplitRequiresService")]
    partial class SplitRequiresService
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmsBus.Web.Entities.Supplier", b =>
                {
                    ...
                    b.Property<bool>("RequiresServiceForActivation")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("RequiresServiceForRental")
                        .HasColumnType("tinyint(1)");
